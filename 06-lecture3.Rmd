...
Our variable of interest (DV, Y) is paid_work_yes: whether the person worked or not. Our treatment variable is treat: whether they received the pamphlet or not. Because this is an experiment, we can compare the averages of the treatment group and the control group to estimate the causal effect. 
